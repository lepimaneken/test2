#!/bin/bash
# pgen.sh - ULTIMATE STEALTH Payload Generator – Defender‑Bypass Injection
...
# ========== STAGE 3 (PowerShell payload loader) with DEFENDER BYPASS INJECTION ==========
echo -e "${YELLOW}[4/6] Creating Stage3.ps1 (Defender‑bypass injection)...${NC}"
